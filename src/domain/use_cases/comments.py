from src.core.exceptions.database_exceptions import CommentNotFound, PostNotFound, UserNotFound
...
from src.infrastructure.repositories.comments import CommentRepository
...
class DeleteCommentUseCase:
    ...
    async def execute(self, comment_id: int) -> None:
        async with self._database.session() as session:
            ...
            await self._repo.delete(session, comment)
